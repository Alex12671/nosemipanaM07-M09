<div class="container">
    ...
    if(isset($editProfileArray)) {
        ...
        <form class="editForm" action='index.php?controller=user&action=EditUserProfile' method='POST' ENCTYPE="multipart/form-data">
            ...
            <label>Cambiar password</label>         <input type='passwd' name='Password' ><br>
    ...
    <a href="index.php?controller=user&action=DeactivateUserProfile">Darse de baja</a><br/>
</div>