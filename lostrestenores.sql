...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2022 a las 11:01:41
...
INSERT INTO `generos` (`IdGenero`, `Nombre`, `Imagen`, `Activo`) VALUES
('B', 'Bélico', 'views/img/B-belico.png', 1),
('CF', 'Ciencia Ficción', 'views/img/CF-ciencia_ficcion.png', 1),
('FM', 'Fantasía medieval', 'views/img/FM-Fantasia_medieval.png', 1),
('NH', 'Novela Histórica', 'views/img/NH-novela_historica.png', 1),
('NN', 'Novela Negra', 'views/img/NN-novela_negra.png', 1),
('T', 'Terror', 'views/img/T-terror.png', 1);
...
(16, 'Dune', 'Cuenta la historia de Paul Atreides, un joven brillante que ha nacido con un destino mucho más grande que él mismo, y deberá viajar al planeta más peligroso del universo para asegurar el futuro de su familia y de su gente', 'CF', 'Frank Herbert', 'Chilton Books', 826, 'views/img/16-Dune.jpeg', 11, '2022-11-22', 100, 1, 'a'),
...
(34, 'La llamada de Chtulhu', 'H. P. Lovecraft ha pasado a la historia de la literatura como uno de los grandes innovadores del relato fantástico y de terror del siglo XX. Niño prodigio empezó a leer y escribir su primer cuento a muy temprana edad. Ya en la adolescencia era de solitar', 'T', ' H.P. Lovecraft', 'ALMA EUROPA', 96, 'views/img/34-Cthulhu.jpg', 7.55, '2022-11-21', 100, 1, 'a'),
